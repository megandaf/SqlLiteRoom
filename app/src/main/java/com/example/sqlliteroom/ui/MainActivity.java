...
import com.example.sqlliteroom.R;
import com.example.sqlliteroom.databinding.ActivityMainBinding;
import com.example.sqlliteroom.helper.ViewModelFactory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.fabAdd.setOnClickListener(view -> {
            if (view.getId() == R.id.fab_add) {
                Intent intent = new Intent(MainActivity.this, InsertUpdateActivity.class);startActivity(intent);
            }
        });
    }
    @Override
